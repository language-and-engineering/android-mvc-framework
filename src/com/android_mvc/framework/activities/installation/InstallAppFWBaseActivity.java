...
import com.android_mvc.framework.common.IAppSettings;
 ...
 *
 */
public abstract class InstallAppFWBaseActivity extends BaseNonMapActivity
{
        ...
        new AsyncTasksRunner( new SequentialAsyncTask[]{
            ...
            new SequentialAsyncTask(){
                ...
                protected boolean main() {
                    ...
                    // DBを初期化
                    init_db_schema();
                    init_db_data( new DBHelper(context).getWritableDatabase() );
     ...
     */
    protected void receiveAppInfoAsFW( IAppSettings settings )
    {
